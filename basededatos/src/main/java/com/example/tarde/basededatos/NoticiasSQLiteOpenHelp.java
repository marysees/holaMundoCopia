 ...
 */
public class NoticiasSQLiteOpenHelp extends SQLiteOpenHelper{
    private Context context;

    public NoticiasSQLiteOpenHelp(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
